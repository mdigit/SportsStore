...
namespace SportsStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_To_Cart()
        {
            ...
            mock.Setup(m => m.Products).Returns(new Product[] { new Product { ProductID = 1, Name = "P1", Catagory = "Apples" }, }.AsQueryable());
            // Arrange - create a new cart
            var cart = new Cart();
        ...
        public void Can_View_Cart_Contents()
        {
            ...
            var result = (CardIndexViewModel)target.Index(cart, "myUrl").ViewData.Model;
        ...
        public void Cannot_Checkout_Invalid_ShippingDetails()
        {
            ...
            // Assert - check that the order hasn't been on to the processor
            mock.Verify(m => m.ProcessOrder(It.IsAny<Cart>(), It.IsAny<ShippingDetails>()), Times.Never);
            // Assert - check that I am passing an invalid model to the view
            Assert.AreEqual(false, result.ViewData.ModelState.IsValid);
        }
